    ...
    <div class="auth-container container">
      <div class="auth-card glass-card animate-fade-in-up">
        <div class="auth-header">
          ...
          <p class="auth-subtitle">Join SplitEase to start splitting expenses</p>
        </div>
        ...
        <form (ngSubmit)="onSubmit()" #registerForm="ngForm" class="auth-form">
          <div class="form-group">
            ...
            <input 
              ...
              required
              #nameInput="ngModel"
              [class.error]="nameInput.invalid && (nameInput.dirty || nameInput.touched || submitted)">
            <span class="form-error" *ngIf="nameInput.invalid && (nameInput.dirty || nameInput.touched || submitted)">
              Name is required.
            </span>
          </div>
          ...
          <div class="form-group">
            ...
            <input 
              ...
              [class.error]="(confirmPasswordInput.invalid || password !== confirmPassword) && (confirmPasswordInput.dirty || confirmPasswordInput.touched || submitted)">
            <span class="form-error" *ngIf="(confirmPasswordInput.invalid || password !== confirmPassword) && (confirmPasswordInput.dirty || confirmPasswordInput.touched || submitted)">
        ...
        <div class="auth-footer">
          <p>Already have an account? <a routerLink="/login" class="text-gradient">Log in</a></p>
        </div>
      </div>
    </div>
  `,
